  ...
  return (
    <div className="p-6 space-y-6 max-w-5xl mx-auto">
      <header className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-black text-slate-900 dark:text-white">{t('zettelkasten.title', 'Zettelkasten')}</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">
            {t('zettelkasten.subtitle', 'Red de conocimiento vinculada al proyecto activo.')}
          </p>
        </div>
      </header>

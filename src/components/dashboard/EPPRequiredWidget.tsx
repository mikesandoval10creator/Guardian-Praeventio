        ...
        <div className="flex items-center justify-center gap-1 sm:gap-4 w-full flex-1 mt-1.5 sm:mt-3">
          <div className="flex gap-1 sm:gap-3">
            <div className="bg-white dark:bg-zinc-900/80 p-1 sm:p-3 rounded-lg sm:rounded-xl shadow-sm text-center w-8 sm:w-16 border border-transparent dark:border-white/5 transition-all">
              ...
              <div className="bg-black dark:bg-zinc-800 text-white text-[6px] sm:text-[10px] font-black py-0.5 rounded-sm uppercase leading-tight">{t('epp_required.helmet', 'Casco')}</div>
            </div>
            <div className="bg-white dark:bg-zinc-900/80 p-1 sm:p-3 rounded-lg sm:rounded-xl shadow-sm text-center w-8 sm:w-16 border border-transparent dark:border-white/5 transition-all">
              <div className="text-sm sm:text-2xl leading-none mb-0.5">🧤</div>
              <div className="bg-black dark:bg-zinc-800 text-white text-[6px] sm:text-[10px] font-black py-0.5 rounded-sm uppercase leading-tight">{t('epp_required.gloves', 'Guantes')}</div>
            </div>
          </div>
          ...
          <div className="bg-white/40 dark:bg-black/20 backdrop-blur-sm rounded-xl sm:rounded-2xl p-1 sm:p-3 shadow-inner w-8 h-8 sm:w-16 sm:h-16 flex flex-col items-center justify-center border border-dashed border-white/60 dark:border-white/10 shrink-0">
            ...
            <span className="text-emerald-800/40 dark:text-emerald-500/40 text-[4px] sm:text-[8px] font-black uppercase tracking-widest text-center px-0.5 leading-tight">{t('epp_required.brand', 'Praeventio')}</span>
          </div>

          <div className="flex gap-1 sm:gap-3">
            <div className="bg-white dark:bg-zinc-900/80 p-1 sm:p-3 rounded-lg sm:rounded-xl shadow-sm text-center w-8 sm:w-16 border border-transparent dark:border-white/5 transition-all">
              <div className="text-sm sm:text-2xl leading-none mb-0.5">🥽</div>
              <div className="bg-black dark:bg-zinc-800 text-white text-[6px] sm:text-[10px] font-black py-0.5 rounded-sm uppercase leading-tight">{t('epp_required.goggles', 'Lentes')}</div>
            </div>
            <div className="bg-white dark:bg-zinc-900/80 p-1 sm:p-3 rounded-lg sm:rounded-xl shadow-sm text-center w-8 sm:w-16 border border-transparent dark:border-white/5 transition-all">
              <div className="text-sm sm:text-2xl leading-none mb-0.5">🥾</div>
              <div className="bg-black dark:bg-zinc-800 text-white text-[6px] sm:text-[10px] font-black py-0.5 rounded-sm uppercase leading-tight">{t('epp_required.boots', 'Zapatos')}</div>
            </div>
          </div>
        </div>
      </div>

    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <div className="p-6 border-b border-white/5 flex items-center justify-between bg-gradient-to-r from-blue-500/10 to-transparent shrink-0">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-blue-500/20 flex items-center justify-center">
                  <ClipboardCheck className="w-6 h-6 text-blue-500" />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-white uppercase tracking-tight">{audit.title}</h3>
            ...
            <div className="p-6 overflow-y-auto flex-1 space-y-6">
              ...
              {isPlanned && !auditData && !generating && (
                <div className="flex flex-col items-center justify-center py-12 gap-4 bg-white/5 rounded-2xl border border-white/10">
                  ...
                  <div className="text-center">
                    <h4 className="text-white font-bold text-lg">Generar Checklist con IA</h4>
              ...
              {generating && (
                <div className="flex flex-col items-center justify-center py-12 gap-4">
                  ...
                  <div className="text-center">
                    <p className="text-sm font-black text-white uppercase tracking-widest">Analizando Red Neuronal</p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    {auditData.items.map((item, index) => (
                      <div key={item.id} className="p-4 bg-zinc-800/50 rounded-2xl border border-zinc-700/50 space-y-4">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 space-y-1">
                            <div className="flex items-center gap-2">
                              <span className="px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-widest bg-indigo-500/20 text-indigo-400">
                                Ref: {item.reference}
                              </span>
                            </div>
                        ...
                        <div className="pl-12 flex flex-col gap-4">
                          <div className="flex flex-col sm:flex-row gap-4 sm:items-center">
                            <div className="flex bg-zinc-900 rounded-xl p-1 border border-zinc-700 shrink-0">
                            ...
                            <div className="flex-1">
                              <input
                                ...
                                className={`w-full bg-zinc-900 border rounded-xl px-4 py-2 text-xs outline-none transition-colors disabled:opacity-70 ${
                          ...
                          {item.status === 'No Cumple' && (
                            <div className="animate-in fade-in slide-in-from-top-2">
                              ...
                              <textarea
                                ...
                                className="w-full bg-zinc-900 border border-indigo-900/30 rounded-xl px-4 py-3 text-xs outline-none focus:border-indigo-500 resize-none h-20 disabled:opacity-70"
                              />
                            </div>
                          )}
                        </div>
            ...
            {auditData && !isCompleted && (
              <div className="p-6 border-t border-white/5 bg-zinc-900 shrink-0 flex justify-end">
                <button
                  onClick={handleSave}

  ...
  return (
    <div className="bg-slate-800/50 rounded-2xl border border-slate-700/50 p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-xl font-bold text-white">Calculadora Estructural y de Carga</h3>
          <p className="text-slate-400 text-sm">Estima la capacidad de carga segura (SWL) para pernos, eslingas y andamios.</p>
        </div>
      </div>
          ...
          <form onSubmit={handleCalculate} className="space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
              >
            ...
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-1">Especificaciones Técnicas</label>
              <textarea
                value={specs}
                onChange={(e) => setSpecs(e.target.value)}
                placeholder="Ej: Diámetro 3/4 pulgada, Grado 8.8, sometido a tracción pura..."
                className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all h-32 resize-none"
                required
              />
            </div>

  ...
  const menuGroups: MenuGroup[] = [
    {
      ...
      items: [
        ...
        // Service exceptionEngine.ts + panel ExceptionsAuditPanel.tsx
        // existían sin page. Cada excepción a un control normal requiere
        // mitigación alternativa + duración máx 168h + aprobador role-gate.

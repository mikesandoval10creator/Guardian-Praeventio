...
// B14 (2026-06-11): este componente es ahora el chat LEGACY, servido solo
// como opt-out explícito (`praeventio:asesor:legacy-optout:v2`) — el
// default del shell es el asistente resiliente (`AsesorChatRouter` →
// `ResilientAsesorLauncher`). `services/slm.ask()` quedó cableado al
// runtime SLM real unificado (Qwen pre-empaquetado, sin mock), así que
// incluso este path legacy hace inferencia real on-device.

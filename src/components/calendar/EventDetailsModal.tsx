            ...
            <div className="p-6 border-b border-white/5 flex items-center justify-between bg-gradient-to-r from-emerald-500/10 to-transparent shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[10px] text-emerald-300 font-bold uppercase tracking-widest truncate">
                    {event.type}
                  </p>
                </div>
              </div>
                ...
                {!isEditing && (
                  <>
                    ...
                    <button
                      ...
                      className="p-2 hover:bg-rose-500/20 rounded-xl transition-colors text-zinc-400 hover:text-rose-500 shrink-0"
                      title="Eliminar"
                    >
              ...
              {isEditing ? (
                <form id="edit-event-form" onSubmit={handleUpdate} className="p-6 space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-zinc-950 border border-white/10 rounded-xl py-3 pl-11 pr-4 text-sm text-white focus:outline-none focus:border-emerald-500 transition-colors"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      className="w-full bg-zinc-950 border border-white/10 rounded-xl py-3 px-4 text-sm text-white focus:outline-none focus:border-emerald-500 transition-colors appearance-none"
                    >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        className="w-full bg-zinc-950 border border-white/10 rounded-xl py-3 pl-11 pr-4 text-sm text-white focus:outline-none focus:border-emerald-500 transition-colors min-h-[100px] resize-none"
                ...
                <div className="p-6 space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-zinc-400 mt-2 whitespace-pre-wrap">{event.description}</p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="col-span-2 bg-zinc-950 p-4 rounded-xl border border-white/5">
                      <div className="flex items-center gap-2 text-zinc-500 mb-1">
              ...
              {isEditing ? (
                <>
                  <button
                    ...
                    className="flex-1 py-3 px-4 rounded-xl font-black text-xs uppercase tracking-widest text-zinc-400 hover:text-white hover:bg-white/5 transition-colors"
                  >
                    Cancelar
                  </button>
                  <button
                ...
                <button
                  onClick={onClose}
                  className="w-full py-3 px-4 rounded-xl font-black text-xs uppercase tracking-widest text-zinc-400 hover:text-white hover:bg-white/5 transition-colors border border-white/10"
                >
                  Cerrar
                </button>
              )}

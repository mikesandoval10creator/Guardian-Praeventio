// Vitest setup file â€” loaded for every test, regardless of environment.
//
// Round 15 (I3) â€” `@testing-library/jest-dom` is now installed. Its

...
// El helper `callerHasSupervisorRole` + el set `QR_SIG_CHALLENGE_ROLES`
// vivían junto al endpoint /qr-signature/challenge pero culture-pulse
// (más abajo en este archivo) también los usa; los preservamos aquí
// como compartidos hasta migrar el resto.

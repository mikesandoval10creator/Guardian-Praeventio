...
// Falling back to a placeholder lets the module load; any actual /send
// call will still fail with an "invalid key" upstream error which is
// the right signal in non-prod.

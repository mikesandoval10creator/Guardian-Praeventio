...
describe('verifyAuth — prod-config guard (Stryker mutants line 33 / 41)', () => {
  ...
  // â”€â”€â”€ Line 33 — startup guard `NODE_ENV === 'production' && E2E_MODE === '1'` â”€â”€â”€
  ...
  // â”€â”€â”€ Line 41 — `isE2EModeEnabled()` â”€â”€â”€
  //
...
describe('verifyAuth — Bearer positive path + sepIdx cluster + StringLiteral pinning (Run #2 mutants)', () => {
  ...
  // â”€â”€â”€ sepIdx cluster (lines 62–63 — Run #2 priority #2) â”€â”€â”€
  ...
  // â”€â”€â”€ StringLiteral cluster (lines 36 / 41 / 53 / 70 / 71 — Run #2 priority #3) â”€â”€â”€

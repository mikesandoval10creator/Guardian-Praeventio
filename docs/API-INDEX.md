...
**205 routers montados · 731 rutas detectadas.**
...
### `src/server/routes/workers.ts` → `/api`
- `PATCH /api/projects/:projectId/workers/:workerId`
...
- `GET /api/sprint-k/:projectId/epp-flow/sign-challenge/:orderId`
...
- `POST /api/sprint-k/:projectId/workforce-period`
- `GET /api/sprint-k/:projectId/operational-pressure`
...
### `src/server/routes/slaWatch.ts` → `/api/sprint-k`
- `GET /api/sprint-k/:projectId/sla-watch`
